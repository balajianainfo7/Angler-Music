...
import 'package:angler_music/resources/app_font.dart';
...
class MusicPlayerPage extends StatefulWidget {
  ...
  @override
  State<MusicPlayerPage> createState() => MusicPlayerPageState();
}
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Padding(
              padding:
                  const EdgeInsets.only(top: 8, bottom: 8, left: 8, right: 25),
              child: CircleAvatar(
                  radius: 18,
                  child: CircleAvatar(
                      radius: 18,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Get.toNamed(RouteNames.musicSearch);
                          },
                          child: Text(
                            'view more',
                            style: TextStyle(
